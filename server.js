...
// User Schema - Enhanced with role system
const userSchema = new mongoose.Schema({
  firstName:  { type: String, required: true, trim: true, maxlength: 50 },
  lastName:   { type: String, required: true, trim: true, maxlength: 50 },
  email:      { type: String, required: true, unique: true, lowercase: true, trim: true },
  password:   { type: String, required: true, minlength: 8, select: false },
  // Role system: super_admin, editor, lead_manager, viewer, user
  role:       { type: String, enum: ['user', 'viewer', 'editor', 'lead_manager', 'super_admin', 'admin'], default: 'user' },
...
// Project Schema - Enhanced with status, image ordering, and view tracking
const projectSchema = new mongoose.Schema({
  ...
  images:      [{ url: String, publicId: String, order: { type: Number, default: 0 } }],
  coverImage:  { type: Number, default: 0 }, // Index of cover image
  beforeImage: { url: String, publicId: String },
  afterImage:  { type: String, publicId: String }, // For before/after slider
  // Project status: completed, in-progress, concept
...
// Message Schema - Enhanced with internal notes, reply, and source tracking
const messageSchema = new mongoose.Schema({
  ...
  source:    { type: String, enum: ['google', 'instagram', 'houzz', 'pinterest', 'referral', 'direct', 'other'], default: 'direct' },
...
// Role-based access control - maps old admin role to new system
